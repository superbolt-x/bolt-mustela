...
WITH data as
    ...
    FROM
        (SELECT 'Meta' as channel, date, date_granularity, 
            spend, 0 as gross_sales, 0 as subtotal_sales, 0 as orders, 0 as first_orders, impressions, link_clicks as clicks, add_to_cart, purchases, revenue, 0 as ga4_purchases, 0 as ga4_revenue
        ...
        SELECT 'Google Ads' as channel, date, date_granularity, 
            spend, 0 as gross_sales, 0 as subtotal_sales, 0 as orders, 0 as first_orders, impressions, clicks, add_to_cart, purchases, revenue, 0 as ga4_purchases, 0 as ga4_revenue
        FROM {{ source('reporting','googleads_campaign_performance') }}
        UNION ALL
        SELECT 'Bing' as channel, date, date_granularity, 
            spend, 0 as gross_sales, 0 as subtotal_sales, 0 as orders, 0 as first_orders, impressions, clicks, 0 as add_to_cart, purchases, revenue, 0 as ga4_purchases, 0 as ga4_revenue
        ...
        SELECT 'Shopify' as channel, date, date_granularity, 
            ...
            0 as clicks, 0 as add_to_cart, 0 as purchases, 0 as revenue, sum(0) as ga4_purchases, sum(0) as ga4_revenue
        ...
        SELECT 'Meta' as channel, date, date_granularity, 
            ...
            sum(purchase) as ga4_purchases, sum(purchase_value) as ga4_revenue
